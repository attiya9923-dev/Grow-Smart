...
<head>
    ...
    <title>
        <?php echo $__env->yieldContent('title', 'GrowSmart | Smart Agriculture Platform'); ?>
    </title>
...
<div id="sidebar">
    ...
    <ul>
        ...
        <li>
            ...
            <a
                href="/dashboard"
                class="<?php echo e(request()->is('dashboard') || request()->is('/') ? 'active' : ''); ?>"
            >
        ...
        <li>
            ...
            <a
                href="/grid"
                class="desktop-crops-data <?php echo e(request()->is('grid') ? 'active' : ''); ?>"
            >
                <i class="bi bi-bar-chart"></i>
                <span>
                    <?php echo e(t('Crops Data')); ?>
            ...
            <div class="mobile-crop-data">
                <button
                    type="button"
                    class="sidebar-dropdown-btn crop-data-button <?php echo e(request()->is('grid') || request()->is('summer') || request()->is('winter') || request()->is('grains') || request()->is('vegetable') || request()->is('fruit') ? 'open' : ''); ?>"
                    onclick="toggleCropMenu()"
                >
                    <i class="bi bi-bar-chart"></i>
                    <span>
                        <?php echo e(t('Crop Data')); ?>
                ...
                <div
                    class="crop-menu <?php echo e(request()->is('grid') || request()->is('summer') || request()->is('winter') || request()->is('grains') || request()->is('vegetable') || request()->is('fruit') ? 'show' : ''); ?>"
                    id="cropMenu"
                >
                    <a href="/grid" class="<?php echo e(request()->is('grid') ? 'active' : ''); ?>"><?php echo e(t('All Crops')); ?></a>
                    <a href="/summer" class="<?php echo e(request()->is('summer') ? 'active' : ''); ?>"><?php echo e(t('Summer')); ?></a>
                    <a href="/winter" class="<?php echo e(request()->is('winter') ? 'active' : ''); ?>"><?php echo e(t('Winter')); ?></a>
                    <a href="/fruit" class="<?php echo e(request()->is('fruit') ? 'active' : ''); ?>"><?php echo e(t('Fruits')); ?></a>
                    <a href="/vegetable" class="<?php echo e(request()->is('vegetable') ? 'active' : ''); ?>"><?php echo e(t('Vegetables')); ?></a>
                    <a href="/grains" class="<?php echo e(request()->is('grains') ? 'active' : ''); ?>"><?php echo e(t('Grains')); ?></a>
                </div>
            </div>
        ...
        <li>
            ...
            <a
                href="/garden"
                class="<?php echo e(request()->is('garden') ? 'active' : ''); ?>"
            >

                <i class="bi bi-bug"></i>

                <span>
                    <?php echo e(t('Pest Management')); ?>
        ...
        <li>
            ...
            <a
                href="/community"
                class="<?php echo e(request()->is('community') ? 'active' : ''); ?>"
            >
        ...
        <li>
            ...
            <a
                href="/soil"
                class="<?php echo e(request()->is('soil') ? 'active' : ''); ?>"
            >

                <i class="bi bi-cpu"></i>

                <span>
                    <?php echo e(t('AI Soil Analysis')); ?>
        ...
        <li>
            ...
            <a
                href="/weather"
                class="<?php echo e(request()->is('weather') ? 'active' : ''); ?>"
            >

                <i class="bi bi-cloud-sun"></i>

                <span>
                    <?php echo e(t('Weather Information')); ?>
        ...
        <li>
            ...
            >
                ...
                <a href="<?php echo e(route('profile')); ?>">
                    ...
                    <span>
                        <?php echo e(t('Add Profile Picture')); ?>
                ...
                >
                    ...
                    <a href="<?php echo e(route('language.change', 'en')); ?>">
                    ...
                    <a href="<?php echo e(route('language.change', 'ur')); ?>">
...
<nav class="navbar-main">
    ...
    <div class="navbar-inner">
        ...
        <div class="category-nav">
            ...
            <a
                href="/dashboard"
                class="nav-item-link nav-home <?php echo e(request()->is('dashboard') || request()->is('/') ? 'active' : ''); ?>"
            >
                <?php if(is_urdu()): ?>
                    صفحۂ اول
                <?php else: ?>
            ...
            <a
                href="/summer"
                class="nav-item-link nav-summer <?php echo e(request()->is('summer') ? 'active' : ''); ?>"
            >
                <?php echo e(t('Summer Crops')); ?>

            </a>

            <a
                href="/winter"
                class="nav-item-link nav-winter <?php echo e(request()->is('winter') ? 'active' : ''); ?>"
            >
            ...
            <a
                href="/grains"
                class="nav-item-link nav-grains <?php echo e(request()->is('grains') ? 'active' : ''); ?>"
            >
                <?php echo e(t('Grains')); ?>
            ...
            <a
                href="/vegetable"
                class="nav-item-link nav-vegetable <?php echo e(request()->is('vegetable') ? 'active' : ''); ?>"
            >
                <?php echo e(t('Vegetables')); ?>

            </a>

            <a
                href="/fruit"
                class="nav-item-link nav-fruit <?php echo e(request()->is('fruit') ? 'active' : ''); ?>"
            >
                <?php if(is_urdu()): ?>
                    پھل
                <?php else: ?>
...
<footer class="footer">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 mb-4">
                ...
                <h5>
                    ...
                    <span><?php echo e(t('GrowSmart')); ?></span>
                </h5>

                <p>
                    <?php echo e(t('GrowSmart is an intelligent agriculture platform helping farmers with crop information, pest management, soil analysis, weather forecasting and expert community support.')); ?>
            ...
            <div class="col-lg-2 col-md-6 mb-4">
                ...
                <h5><?php echo e(t('Quick Links')); ?></h5>
        ...
        <div class="footer-bottom">
            ...
            © <?php echo e(date('Y')); ?> <span><?php echo e(t('GrowSmart')); ?></span>. <?php echo e(t('All Rights Reserved.')); ?>


            <br>

            <?php echo e(t('Empowering Farmers Through Smart Agriculture.')); ?>
...
<div id="logoutModal">
    ...
    <div class="logout-box">
        ...
        <p>
            <?php echo e(t('Are you sure you want to logout from GrowSmart?')); ?>
...
<?php /**PATH C:\Users\mg\Downloads\GrowSmart_urdu_rtl_sidebar_fixed_final\resources\views/layouts/app.blade.php ENDPATH**/ ?>