...
<div class="pest-page">
    ...
    <div class="pest-hero">
        <div class="pest-hero-content">
            ...
            <p>
                <?php echo e(t('Explore pest management information for seasonal crops, including common crop pests and agricultural protection guidance.')); ?>
    ...
    <div class="crop-section">
        ...
        <div class="section-header">
            ...
            <div class="section-title-wrapper">
                ...
                <div>
                    ...
                    <p class="section-description">
                        <?php echo e(t('Pest management information for warm-season crops.')); ?>
            ...
            <div class="crop-count">
                ...
                <?php echo e($summerCrops->count()); ?> <?php echo e(t('Crops')); ?>
                ...
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    ...
                    <div class="col-12">
                        ...
                        <div class="empty-state">
                            ...
                            <h5>
                                <?php echo e(t('No Summer Crops Found')); ?>

                            </h5>

                            <p>
                                <?php echo e(t('There are currently no summer crops available.')); ?>
        ...
        <div class="section-header">
            ...
            <div class="section-title-wrapper">
                ...
                <div>
                    ...
                    <p class="section-description">
                        <?php echo e(t('Pest management information for cool-season crops.')); ?>
            ...
            <div class="crop-count">
                <i class="bi bi-flower1"></i>
                <?php echo e($winterCrops->count()); ?> <?php echo e(t('Crops')); ?>
                ...
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    ...
                    <div class="col-12">
                        ...
                        <div class="empty-state">
                            ...
                            <h5>
                                <?php echo e(t('No Winter Crops Found')); ?>

                            </h5>

                            <p>
                                <?php echo e(t('There are currently no winter crops available.')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\mg\Downloads\GrowSmart_urdu_rtl_sidebar_fixed_final\resources\views/front/garden.blade.php ENDPATH**/ ?>