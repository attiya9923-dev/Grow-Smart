<?php $__env->startSection('title', (t('Summer Crops')) . ' | GrowSmart'); ?>
...
<div class="crop-page-header">
    ...
    <div class="header-content">
        ...
        <p class="crop-page-subtitle">
            <?php echo e(t('Discover crops suitable for the summer season and explore detailed information about their cultivation and management.')); ?>
        ...
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
            ...
            <div class="col-12">
                ...
                <div class="empty-state">
                    ...
                    <h5>
                        No <?php echo e(t('Summer Crops')); ?> Available
                    </h5>

                    <p>
                        <?php echo e(t('There are currently no summer crops available. Please check back later.')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\mg\Downloads\GrowSmart_urdu_rtl_sidebar_fixed_final\resources\views/front/summer.blade.php ENDPATH**/ ?>