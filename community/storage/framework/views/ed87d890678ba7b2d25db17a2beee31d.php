...
<div class="questions-box">
    ...
    <div class="page-title">
        ...
        <p><?php echo e(t('Answer the user\'s vegetable questions')); ?></p>
    </div>
    ...
    <?php $__empty_1 = true; $__currentLoopData = $questions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $question): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        ...
        <div class="question-card">
            ...
            <div class="question-title">
                🥬 <?php echo e(t('Vegetable Question')); ?>
                ...
                <div class="existing-answers" style="background:#f8fbf8;border:1px solid #dcebdd;border-radius:12px;padding:15px;margin-bottom:18px;">
                    ...
                    <?php $__currentLoopData = $question->answers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $answer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div style="background:#fff;border-radius:10px;padding:12px;margin-bottom:8px;">
                            ...
                            <strong>
                                👨‍🌾 <?php echo e($answer->expert->name ?? t('Expert')); ?>
    ...
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
        ...
        <div class="empty-box">
            <?php echo e(t('This user has no unanswered crop questions.')); ?>
    ...
    <div class="back-wrapper">
        <a href="<?php echo e(route('expert.vegetable.users')); ?>" class="back-btn">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\mg\Downloads\GrowSmart_urdu_rtl_sidebar_fixed_final\resources\views/expert/vegetable_user_questions.blade.php ENDPATH**/ ?>