...
<div class="container">
   ...
   <div class="heading"> 
    <h1>
        <?php echo e(t('🌾 Crop Community')); ?>

    </h1>

    <p>
        <?php echo e(t('Ask your crop questions and get help from agricultural experts.')); ?>
    ...
    <div class="form-box">
        ...
        >
            ...
            <div class="form-group">
                ...
                <label><?php echo e(t('Upload Crop Image')); ?></label>
            ...
            <div class="form-group">
                ...
                <textarea
                    name="question_text"
                    id="question_text"
                    placeholder="<?php echo e(t('Write your crop problem here...')); ?>"
                ></textarea>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\mg\Downloads\GrowSmart_urdu_rtl_sidebar_fixed_final\resources\views/user/crop.blade.php ENDPATH**/ ?>