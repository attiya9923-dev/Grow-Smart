...
<head>
    ...
    <title><?php echo e(t('GrowSmart | Email Verification')); ?></title>
...
<div class="container">
    ...
    <div class="left">
        ...
        <h2>
            ...
            <?php echo e(t('Verify Your Email')); ?>
        ...
        <p class="subtitle">
            ...
            <?php echo e(t('One more step to complete your GrowSmart account.')); ?>
        ...
        <?php if($errors->any()): ?>
            ...
            <div class="message error">
                ...
                <?php $__currentLoopData = $errors->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div><?php echo e(auth_text($error)); ?></div>
        ...
        <p class="info-text">
            ...
            <?php echo e(t('Enter the 6-digit verification code that was sent to your email address.')); ?>


        </p>

        <form
            action="<?php echo e(route('verify.otp')); ?>"
            method="POST"
        >
            ...
            <input
                ...
                name="otp"
                class="otp-input"
                placeholder="<?php echo e(t('Enter OTP')); ?>"
                maxlength="6"
                minlength="6"
                inputmode="numeric"
                pattern="[0-9]{6}"
    ...
    <div class="right">
        ...
        <div class="right-content">
            ...
            <p>
                ...
                <?php echo e(t('Verify your email address and start benefiting from better agricultural information, farming solutions and our growing community.')); ?>
...
</html><?php /**PATH C:\Users\mg\Downloads\GrowSmart_urdu_rtl_sidebar_fixed_final\resources\views/auth/verify-otp.blade.php ENDPATH**/ ?>