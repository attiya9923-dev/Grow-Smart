...
document.addEventListener('DOMContentLoaded', function () { 
    ...
    const prepare = () => { 
        if (slider.dataset.ready === '1' || slider.children.length < 2) return; 
        const original = Array.from(slider.children); 
        original.forEach(card => slider.appendChild(card.cloneNode(true))); 
        slider.dataset.ready = '1'; 
    }; 
 
    const move = () => { 
        if (moving || slider.children.length < 2) return; 
        const step = getStep(); 
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\mg\Downloads\GrowSmart_urdu_rtl_sidebar_fixed_final\resources\views/front/dashboard.blade.php ENDPATH**/ ?>