...
<div class="expert-users-container">
    ...
    <h2>🍎 <?php echo e(t('Users Fruit Questions')); ?></h2>
    <p class="intro">
    ...
    <?php $__empty_1 = true; $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <div class="user-card">
            ...
            <div class="user-actions">
                <a href="<?php echo e(route('expert.fruit.user.questions', $user->id)); ?>" class="view-btn">
                ...
                <div class="more-wrap">
                    ...
                    <div class="more-menu">
                        <form action="<?php echo e(route('expert.user.hide', $user->id)); ?>" method="POST" class="hide-user-form" data-category="fruit" data-user-name="<?php echo e($user->name); ?>">
                            <?php echo csrf_field(); ?>
...
<div class="expert-delete-modal" id="expertDeleteModal-fruit" aria-hidden="true">
    ...
    <div class="expert-delete-box" role="dialog" aria-modal="true">
        ...
        <p id="expertDeleteMessage-fruit"><?php echo e(t('The user account and questions will not be deleted.')); ?></p>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\mg\Downloads\GrowSmart_urdu_rtl_sidebar_fixed_final\resources\views/expert/fruit_users.blade.php ENDPATH**/ ?>