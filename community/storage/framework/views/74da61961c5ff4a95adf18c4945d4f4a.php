...
<div class="container-box" dir="<?php echo e(is_urdu() ? 'rtl' : 'ltr'); ?>">
    ...
    <div class="heading">
        ...
        <p>
            <?php echo e(t('Add and manage all crops in your website.')); ?>
    ...
    <div class="actions">
        ...
        <a href="<?php echo e(route('admin.crop.urdu.data.create')); ?>" class="btn data">
            🇵🇰 <?php echo e(t('Add / Update Urdu Crop Data')); ?>
    ...
    <div class="crop-grid">
        ...
        <?php $__empty_1 = true; $__currentLoopData = $crops; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $crop): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            ...
            <div class="crop-card">
                ...
                <div class="info">
                    ...
                    <?php echo e($crop->type ? local_text($crop, 'type') : t('Not specified')); ?>
                ...
                <?php else: ?>
                    ...
                    <span class="badge missing-badge">
                        ...
                        <?php echo e(t('Crop Data Missing')); ?>
                ...
                <?php if($crop->urdu_completed): ?>
                    <span class="badge">✓ <?php echo e(t('Urdu Crop Complete')); ?></span>
                <?php else: ?>
                    <a href="<?php echo e(route('admin.crop.urdu.data.create', ['crop_id' => $crop->id])); ?>" class="badge missing-badge" style="text-decoration:none;">🇵🇰 <?php echo e(t('Add Urdu Crop Data')); ?></a>
                <?php endif; ?>
        ...
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
            ...
            <div class="empty-box">
                ...
                <h3>
                    <?php echo e(t('No crops available.')); ?>

                </h3>

                <p>
                    <?php echo e(t('Click "Add Crop" to create your first crop.')); ?>
...
>
    ...
    <div class="delete-modal-content">
        ...
        <p>
            <?php echo e(t('Are you sure you want to delete this crop?')); ?>

            <?php echo e(t('This action cannot be undone.')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\mg\Downloads\GrowSmart_urdu_rtl_sidebar_fixed_final\resources\views/admin/crop_management.blade.php ENDPATH**/ ?>