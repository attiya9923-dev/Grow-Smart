<?php $__env->startSection('title', (t('Grains')) . ' | GrowSmart'); ?>
...
<style>
    ...
    .crop-section {
        ...
        padding: 18px;
        box-shadow: 0 7px 25px rgba(23, 59, 50, 0.07);
    }
    ...
    .crop-card:hover {
        ...
        border-color: #b8d0c1;
        box-shadow: 0 15px 32px rgba(23, 59, 50, 0.15);
    }
...
<div class="crop-hero">
    ...
    <p class="crop-page-subtitle">
        <?php echo e(t('Explore different types of grains and discover useful agricultural information, growing guidance, and crop details.')); ?>
        ...
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
            ...
            <div class="col-12">
                ...
                <div class="empty-state">
                    ...
                    <h5>
                        <?php echo e(t('No Grains Available')); ?>

                    </h5>

                    <p>
                        <?php echo e(t('There are currently no grains available to display.')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\mg\Downloads\GrowSmart_urdu_rtl_sidebar_fixed_final\resources\views/front/grains.blade.php ENDPATH**/ ?>