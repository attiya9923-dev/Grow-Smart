...
<div class="container">
     ...
     <div class="heading"> 
    <h1>
        {{ t('🥬 Vegetable Community') }}
    </h1>

    <p>
        {{ t('Ask your vegetable questions and get help from agricultural experts.')
        }}
    </p>
</div>
    ...
    <div class="form-box">
        ...
        >
            ...
            <div class="form-group">
                ...
                <label>{{ t('Upload Vegetable Image') }}</label>
            ...
            <div class="form-group">
                ...
                <label>{{ t('Ask Your Question') }}</label>

                <textarea
                    name="question_text"
                    id="question_text"
                    placeholder="{{ t('Write your vegetable problem here...') }}"
                ></textarea>
...
recordBtn.onclick = async function() {
    ...
    try {
        ...
        recorder.onstop = function() {
            ...
            recordBtn.innerHTML = "🎤";
            recordBtn.title = "{{ t('Start recording') }}";
        ...
        alert("{{ t('Please allow microphone permission to record your voice.') }}");
