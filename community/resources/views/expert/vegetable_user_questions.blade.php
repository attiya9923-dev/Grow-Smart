...
<div class="questions-box">
    ...
    <div class="page-title">
        ...
        <p>{{ t('Answer the user\'s vegetable questions') }}</p>
    </div>
    ...
    @empty
        ...
        <div class="empty-box">
            {{ t('This user has no unanswered crop questions.') }}
        </div>

    @endforelse

    <div class="back-wrapper">
        <a href="{{ route('expert.vegetable.users') }}" class="back-btn">
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function createVoicePlayer(blob, input, voiceList) {
        ...
        deleteButton.innerHTML = `🗑 {{ t('Delete Recording') }}`;
