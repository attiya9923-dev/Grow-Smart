    ...
    @forelse($users as $user)
        <div class="user-card">
            ...
            <div class="user-actions">
                <a href="{{ route('expert.crop.user.questions', $user->id) }}" class="view-btn">
                    {{ t('View Questions') }}
                </a>
                ...
                <div class="more-wrap">
                    ...
                    <div class="more-menu">
                        <form action="{{ route('expert.user.hide', $user->id) }}" method="POST" class="hide-user-form" data-category="crop" data-user-name="{{ $user->name }}">
                            @csrf
                            @method('DELETE')
...
<div class="expert-delete-modal" id="expertDeleteModal-crop" aria-hidden="true">
    ...
    <div class="expert-delete-box" role="dialog" aria-modal="true">
        ...
        <p id="expertDeleteMessage-crop">{{ t('The user account and questions will not be deleted.') }}</p>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const deleteModal = document.getElementById('expertDeleteModal-crop');
