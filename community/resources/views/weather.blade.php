...
<div class="weather-header">
    <div class="weather-header-content">
        ...
        <h1>{{ t('Weather Info') }}</h1>

        <p>
            {{ t('Check the current weather and forecast for your area. Use this information to plan your farming activities.') }}
        </p>
...
<div id="loadingSection">
    ...
    <div class="location-box">
        ...
        <h4>{{ t('Weather Permission Required') }}</h4>

        <p>
            {{ t('Allow your location to see the current weather in your area.') }}
        </p>

        <button class="location-btn" onclick="getLocation()">
            <i class="bi bi-geo-alt me-2"></i>
            {{ t('Show Weather Using Location') }}
        </button>
...
<div id="weatherSection" style="display:none;">
    ...
    <div class="section-heading">
        ...
        <div>
            <h3>{{ t('Five Day Forecast') }}</h3>

            <p>
                {{ t('Weather conditions for the coming days') }}
            </p>
        </div>
...
function getLocation() {
    ...
    if (!navigator.geolocation) {
        showError(@json(t('Your browser does not support location services.')));
        return;
    }
    ...
    document.getElementById('loadingSection').innerHTML = `
        <div class="location-box loading-box">
            ...
            <p class="mt-3 mb-0">{{ t('Finding your location...') }}</p>
        </div>
    `;
        ...
        function() {
            ...
            document.getElementById('loadingSection').innerHTML = `
                <div class="location-box">
                    ...
                    <h4>{{ t('Location Permission Required') }}</h4>

                    <p>
                        {{ t('Please allow location access from your browser to see your local weather.') }}
                    </p>
            ...
            showError(@json(t('Location access was not allowed. Please allow location access in your browser.')));
        }
    );
}
...
function fetchWeather(lat, lon) {
    ...
    .catch(() => {
        showError(@json(t('Weather data could not be loaded. Please check your internet connection and try again.')));
    });
}
