...
@section('title', t('Account Settings | GrowSmart'))
    ...
    <div class="settings-wrapper">
        ...
        <div class="settings-title">
            ...
            <div>
                ...
                <p>
                    {{ t('Manage your email, password and account security.') }}
                </p>
            </div>
        ...
        <div class="settings-card">
            ...
            <div class="card-heading">
                ...
                <div>
                    ...
                    <p>
                        {{ t('Update your email and verify the new address.') }}
                    </p>
                ...
                >
                    ...
                    <div class="verification-note">
                        ...
                        <span>
                            ...
                            {{ t('A 6-digit verification code will be sent to your new email address.') }}
            ...
            @else
                ...
                <div class="otp-verification-box">
                    ...
                    <p class="otp-description second">
                        ...
                        {{ t('Enter the code below to confirm your new email address.') }}
        ...
        <div class="settings-card">
            ...
            <div class="card-heading">
                ...
                <div>
                    ...
                    <p>
                        {{ t('Create a strong password to protect your account.') }}
                    </p>
        ...
        <div class="security-card">
            ...
            <div>
                ...
                <p>
                    ...
                    {{ t('When you change your email address, GrowSmart will send a verification code to the new email. Your email will only be changed after the correct 6-digit code is entered.') }}
