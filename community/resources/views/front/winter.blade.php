...
@section('title', (t('Winter Crops')) . ' | GrowSmart')
...
<div class="crop-hero">
    ...
    <div class="crop-hero-content">
        ...
        <p class="crop-page-subtitle">
            {{ t('Explore crops that thrive during the winter season and discover useful agricultural information and growing guidance for each crop.') }}
        </p>
        ...
        @empty
            ...
            <div class="col-12">
                ...
                <div class="empty-state text-center">
                    ...
                    <h5>
                        {{ t('No winter crops available') }}
                    </h5>

                    <p>
                        {{ t('There are currently no winter crops available to display.') }}
                    </p>
