...
@section('title', (t('Fruits')) . ' | GrowSmart')
...
<div class="crop-page">
    ...
    <div class="crop-hero">
        ...
        <p class="crop-page-subtitle">
            {{ t('Discover a variety of fruits and explore detailed agricultural information, growing guidance, and useful crop details.') }}
        </p>
            ...
            @empty
                ...
                <div class="col-12">
                    ...
                    <div class="empty-state">
                        ...
                        <h5>
                            {{ t('No Fruits Available') }}
                        </h5>

                        <p>
                            {{ t('There are currently no fruits available to display.') }}
                        </p>
