...
<head>
    ...
    <title>{{ t('GrowSmart | Create Account') }}</title>
    ...
    <div class="right">
        ...
        <div class="right-content">
            ...
            <h3 class="right-title">
                {{ t('Grow Smarter. Farm Better.') }}
            </h3>

            <p class="right-description">
                {{ t('Connect with the GrowSmart community and discover smarter agricultural knowledge and solutions.') }}
            </p>
