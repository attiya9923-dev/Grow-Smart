...
<div class="container">
    ...
    <div class="left">
        ...
        <p class="subtitle">
            {{ t('Log in to your account to continue your smart agriculture journey.') }}
        </p>
    ...
    <div class="right">
        ...
        <div class="right-content">
            ...
            <p>
                ...
                {{ t('Discover smarter agricultural knowledge, better farming decisions and a connected farming community with GrowSmart.') }}
